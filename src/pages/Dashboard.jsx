...
const Dashboard = () => {
  ...
  if (chartData.length === 0) {
    return (
      <div className="min-h-screen flex items-center justify-center text-black bg-appGray-light dark:bg-gray-900 dark:text-white">
  ...
  return (
    <div className="min-h-screen bg-appGray-light dark:bg-gray-900 dark:text-white text-black">
      <header
        className="text-black py-4 px-6 shadow-md flex items-center justify-between dark:bg-gray-800"
